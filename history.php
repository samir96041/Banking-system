 ...
 -->
    ...
    <center>
        ...
        <div class="container" style="margin-top: 10%; padding:10px 80px 10px 80px; ">
            <div
                style="width:80%; background-color:rgba(255, 255, 255, 0.5); padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px gray;">
                <h1 style=" color:rgb(0, 0, 0);">All Customers</h1>
            </div>
            <?php
            ...
            <table class="table table-dark" style="margin-top: 30px;">
                ...
                <style>
                    .mybtn {
                        ...
                        box-shadow: 2px 2px 10px rgb(205, 147, 147);
                        border-radius: 30px;
                        font-weight: bold;
